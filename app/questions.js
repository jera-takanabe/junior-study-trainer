// =========================================================
// 漢検5級：全セット統合 questions.js v0.6
// 収録：Set 001〜Set 003
//
// 対応アプリ：timed_quiz_trainer_v0_6_set_switching
//
// 使い方：
// 1. このファイル内容を questions.js として保存する
// 2. index.html v0.6 と同じフォルダに置く
...
window.QUIZ_SETS = [
  {
    ...
    seriesName: "基本熟語・日常語",
    order: 1,
    description: "承認・誕生・異常・勤勉・簡単・貴重・結果・責任・供給など、最初に扱う基本語彙を扱う。"
  },
  {
    setId: "s002",
    setName: "基本熟語・日常語 02",
...
const SET_BY_ID = Object.fromEntries(window.QUIZ_SETS.map((s) => [s.setId, s]));
...
// 簡易チェック用。ブラウザの開発者ツールで確認できます。
console.log("QUIZ_SETS", window.QUIZ_SETS.length, window.QUIZ_SETS);
console.log("QUIZ_QUESTIONS", window.QUIZ_QUESTIONS.length);
